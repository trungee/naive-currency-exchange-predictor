...
public class PredictorTest {
    ...
    public void predictorTest() {
        Predictor predictor = new Predictor(initSample());
        Assert.assertEquals(new BigDecimal("3.104668"), predictor.predict(1));
        Assert.assertEquals(new BigDecimal("3.091987"), predictor.predict(2));
        Assert.assertEquals(new BigDecimal("3.079306"), predictor.predict(3));
    }
}
